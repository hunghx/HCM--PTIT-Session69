...
export const RegisterPage = () => {
    ...
    const handleSubmitForm = (e: React.FocusEvent<HTMLFormElement>) => {
        ...
        if (!registerForm.email.toLowerCase()
            ...
            // ko hợp lệ
            setError(pre => ({ ...pre, email: 'e mail ko đúng định dạng' }));
            return
        }
    ...
    <div className='form-login'>
        ...
        <Form className='border border-2 p-4 rounded-2 w-50' onSubmit={handleSubmitForm} >
            ...
            <Form.Group className="mb-3" >
                ...
                <Form.Control type="password" placeholder="Enter password" value={registerForm.password} name="password" onChange={handleInput} />
                {
            ...
            <Form.Group className="mb-3" >
                ...
                <Form.Control type="password" placeholder="Enter confirm password" value={registerForm.passwordConfirm} name="passwordConfirm" onChange={handleInput} />
            </Form.Group>
            <Form.Group className="mb-3">
